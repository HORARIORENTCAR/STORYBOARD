            ...
            <button
              onClick={async () => {
                ...
                const texto = [
                  ...
                  ``,
                  `IMPORTANTE: no toques el enlace desde aquí. WhatsApp abre los`,
                  `enlaces en un navegador interno que NO puede instalar apps.`,
                  `Mantén pulsada esta dirección, cópiala, y pégala en Chrome`,
                  `(Android) o en Safari (iPhone):`,
                  ``,
                  `${sitio}/instalar`,
                  ``,
                  `Ahí te dice, paso a paso, cómo dejar el ícono de la app en tu`,
                  `pantalla de inicio. No se descarga de Google Play ni de la App`,
                  `Store: se instala desde esa misma página.`,
                  ``,
                  `Después entra con estos datos:`,
