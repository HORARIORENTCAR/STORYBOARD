  ...
  return (
    <Modal open={open} onClose={onClose} eyebrow="Equipo" title="Agregar colaborador" size="sm">
      <div className="-mt-3 mb-4 rounded-xl border border-ink-200 bg-ink-50 px-3.5 py-2.5 text-xs leading-relaxed text-ink-600">
        Recibirá un correo con un enlace para <strong>crear su propia contraseña</strong> de Staff Board.
        No usa la contraseña de su correo institucional ni la comparte con nadie.
      </div>
      <form
        onSubmit={async (e) => {
          e.preventDefault();
